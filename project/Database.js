            ...
            async.waterfall([
                ...
                function(args, callback){
                    ...
                    args.forEach(ware => {                        
                        ...
                        connection.query(sqlReduceInventory, [ware.amount, ware.product_id], function (err, result) {
                            if (err) throw err;
                        });
                    });
            ...
            async.waterfall([
                ...
                function(wares, callback){
                    ...
                    wares.forEach(pair => {
                        ...
                        // its originall value
                        connection.query(sqlIncreaseInventory, [pair[0], pair[1]], function (err, result) {
                            if (err) throw err;
                        });
                    });
                    callback(null)
